...
const Business = () => {
    return (
        <main>
            ...
            <button className='applybutton'><a href='https://uncg.qualtrics.com/jfe/form/SV_6M2Ms5ELhEVlu5v?Q_JFE=qdg' target='_blank'><h3 className='applytext'>APPLY AS BUSINESS</h3></a> </button>
